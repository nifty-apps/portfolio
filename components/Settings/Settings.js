    ...
    <div className={classes.setting}>
      ...
      >
        <List
          ...
          subheader={(
            <ListSubheader component="div">
              {t('profile-landing.header_theme')}
            </ListSubheader>
          )}
        >
          <ListItem>
            <Typography component="div">
              <Grid component="label" container alignItems="center" spacing={1}>
                <Grid item>{t('profile-landing.header_light')}</Grid>
                <Grid item>
                  <Switch
                    checked={isDark}
                ...
                <Grid item>{t('profile-landing.header_dark')}</Grid>
              </Grid>
            </Typography>
          </ListItem>
        </List>
        ...
        <List
          ...
          subheader={(
            <ListSubheader component="div">
              {t('profile-landing.header_language')}
            </ListSubheader>
          )}
        >
